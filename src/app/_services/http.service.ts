...
export class HttpService {
    authenticationService: UserLogged = new UserLogged();
  constructor(
    private http: HttpClient) {
  }

  getToken(): string {
    return this.authenticationService.getCurrentUser() ? this.authenticationService.getCurrentUser().token : '';
  }
  ...
  get(url:any, token?: string, header?: any) {
    ...
    return this.http.get<any>(API_SERVICE.BASE_URL + url, { headers: headers });
  }
...
fetch(url?: any, method?: any, params?: any, userToken?: any) {
  ...
  post(url:any, params:any, token?: string): Observable<any> {
    ...
    return this.http.post<any>(API_SERVICE.BASE_URL + url, params, { headers: header });
  }
